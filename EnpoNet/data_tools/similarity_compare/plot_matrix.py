...
def run_overall(imgs_path, dataset):
    ...
    """
    from EnpoNet.data_tools.similarity_compare.dataset_vector import run as run_images_to_vectors
    img_paths = run_images_to_vectors(imgs_path, dataset)

    from EnpoNet.data_tools.similarity_compare.similar_matrix import run as run_vector_to_similarity_matrix
